...
export async function renderGuide(report, css) {
  ...
  const nav = `<nav class="nav-index"><div class="nav-inner"><a class="nav-item nav-home" href="../../index.html">← 銘柄一覧へ</a><a class="nav-item active" href="index.html">企業ガイド</a><a class="nav-item" href="${h(report.meta.ticker)}.html">結論</a><a class="nav-item" href="catalysts.html">カタリスト</a>${[...allSections, ...extras].map((section, index) => `<a class="nav-item" href="#${h(section.id)}">${index + 1} ${h(section.title)}</a>`).join("")}<a class="nav-item" href="#sources">出典</a></div></nav>`;
...
export async function renderScenario(report, css) {
  ...
  const nav = `<nav class="report-nav"><div class="wrap"><a href="../../index.html">← 銘柄一覧へ</a><a href="index.html">企業ガイド</a><a class="active" href="${h(report.meta.ticker)}.html">結論</a><a href="#snapshot">概要</a><a href="#scenarios">3シナリオ</a><a href="#logic">計算</a><a href="#assumptions">前提</a><a href="#sources">出典</a></div></nav>`;
